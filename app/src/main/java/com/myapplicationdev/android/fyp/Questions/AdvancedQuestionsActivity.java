...
public class AdvancedQuestionsActivity extends AppCompatActivity {
    ...
    ImageView ivQuestion, ivChoice1, ivChoice2, ivDidYouKnow,ivSolution1,ivSolution2;
...
//  TODO: When the user clicks the "did you know?" icon on the screen, text messages are prepared for them.
        ...
        String didYouKnowIconMsgQ10 = "Anastrozole is a non-steroidal Aromatase inhibitor which is used for treatment of Breast Cancer.\n" +
                "\n" +
                "Anastrozole works by decreasing the amount of estrogen the female body makes by reversibly binding to the aromatase enzyme  where it blocks the conversion of androgens and testosterone into estrogen via competitive inhibition. \n" +
                "\n" +
                "This will block the biosynthesis of estrogen and will eventually  slow  or stop the growth of many types of breast cancer cells that need estrogen to grow.\n";
        ...
        al.add(new QuestionAdvanced("advanced", "1", didYouKnowIconMsgQ1, R.drawable.question1_advanced, 1,
                ...
                R.drawable.question1_advanced_carbocation3_incorrect, 1, 0, 0, 0, 0, 0, 0, 0,R.drawable.question1_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "2", didYouKnowIconMsgQ2, R.drawable.question2_advanced, 1,
                ...
                R.drawable.question2_advanced_reaction3_incorrect, 3, 0, 0, 0, 0, 0, 0, 0,R.drawable.question2_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "3", didYouKnowIconMsgQ3, R.drawable.question3_advanced, 2,
                ...
                R.drawable.question3_advanced_carbocation1_incorrect, R.drawable.question3_advanced_carbocation2_incorrect, R.drawable.question3_advanced_carbocation3_incorrect, 1,R.drawable.question3_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "4", didYouKnowIconMsgQ4, R.drawable.question4_advanced, 1,
                ...
                R.drawable.question4_advanced_startingmaterial_correct, 4, 0, 0, 0, 0, 0, 0, 0,R.drawable.question4_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "5", didYouKnowIconMsgQ5, R.drawable.question5_advanced, 2,
                ...
                R.drawable.question5_advanced_product2_incorrect, R.drawable.question5_advanced_product3_incorrect, R.drawable.question5_advanced_product_correct, 4,R.drawable.question5_advanced_solution1,R.drawable.question5_advanced_solution2));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "6", didYouKnowIconMsgQ6, R.drawable.question6_advanced, 2,
                ...
                R.drawable.question6_advanced_product1_incorrect, R.drawable.question6_advanced_product3_incorrect, R.drawable.question6_advanced_product2_incorrect, 1,R.drawable.question6_advanced_solution1,R.drawable.question6_advanced_solution2));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "7", didYouKnowIconMsgQ7, R.drawable.question7_advanced, 1,
                ...
                R.drawable.question7_advanced_reaction3_incorrect, 2, 0, 0, 0, 0, 0, 0, 0,R.drawable.question7_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "8", didYouKnowIconMsgQ8, R.drawable.question8_advanced, 1,
                ...
                R.drawable.question8_advanced_reaction_correct, 4, 0, 0, 0, 0, 0, 0, 0,R.drawable.question8_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "9", didYouKnowIconMsgQ9, R.drawable.question9_advanced, 1,
                ...
                R.drawable.question9_advanced_carbocation3_incorrect, 3, 0, 0, 0, 0, 0, 0, 0,R.drawable.question9_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "10", didYouKnowIconMsgQ10, R.drawable.question10_advanced, 1,
                ...
                R.drawable.question10_advanced_startingmaterial3_incorrect, 1, 0, 0, 0, 0, 0, 0, 0,R.drawable.question10_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "11", didYouKnowIconMsgQ11, R.drawable.question11_advanced, 1,
                ...
                R.drawable.question11_advanced_startingmaterial_correct, 4, 0, 0, 0, 0, 0, 0, 0,R.drawable.question11_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "12", didYouKnowIconMsgQ12, R.drawable.question12_advanced, 1,
                ...
                R.drawable.question12_advanced_product3_incorrect, 2, 0, 0, 0, 0, 0, 0, 0,R.drawable.question12_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "13", didYouKnowIconMsgQ13, R.drawable.question13_advanced, 1,
                ...
                R.drawable.question13_advanced_product3_incorrect, 2, 0, 0, 0, 0, 0, 0, 0,R.drawable.question13_advanced_solution,0));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "14", didYouKnowIconMsgQ14, R.drawable.question14_advanced, 1,
                ...
                R.drawable.question14_advanced_solvent_correct, 4, 0, 0, 0, 0, 0, 0, 0,R.drawable.question14_advanced_solution,0));
        //<--- MAJORPRODUCT--->
        al.add(new QuestionAdvanced("advanced", "15", didYouKnowIconMsgQ15, R.drawable.question15_advanced, 2,
                ...
                R.drawable.question15_advanced_majorproduct1_incorrect, R.drawable.question15_advanced_majorproduct2_incorrect, R.drawable.question15_advanced_majorproduct3_incorrect, 1,R.drawable.question15_advanced_solution1,R.drawable.question15_advanced_solution2));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "16", didYouKnowIconMsgQ16, R.drawable.question16_advanced, 2,
                ...
                R.drawable.question16_advanced_product1_incorrect, R.drawable.question16_advanced_product2_incorrect, R.drawable.question16_advanced_product3_incorrect, 1,R.drawable.question16_advanced_solution1,R.drawable.question16_advanced_solution2));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "17", didYouKnowIconMsgQ17, R.drawable.question17_advanced, 2,
                ...
                R.drawable.question17_advanced_product1_incorrect, R.drawable.question17_advanced_product2_incorrect, R.drawable.question17_advanced_product3_incorrect, 1,R.drawable.question17_advanced_solution1,R.drawable.question17_advanced_solution2));
        //<--- --->
        al.add(new QuestionAdvanced("advanced", "18", didYouKnowIconMsgQ18, R.drawable.question18_advanced, 2,
                ...
                R.drawable.question18_advanced_product1_incorrect, R.drawable.question18_advanced_product2_incorrect, R.drawable.question18_advanced_product3_incorrect, 1,R.drawable.question18_advanced_solution1,R.drawable.question18_advanced_solution2));
        //<--- MAJORPRODUCT--->
        al.add(new QuestionAdvanced("advanced", "19", didYouKnowIconMsgQ19, R.drawable.question19_advanced, 2,
                ...
                R.drawable.question19_advanced_product1_incorrect, R.drawable.question19_advanced_product2_incorrect, R.drawable.question19_advanced_product3_incorrect, 1,R.drawable.question19_advanced_solution1,R.drawable.question19_advanced_solution2));
                ...
                if (currentQuestion.getQnCount() == 2) {
                    ...
                    if (ans1 == currentQuestion.getCorrectNum1() && ans2 == currentQuestion.getCorrectNum2()) {
                        ...
                        if (streak == 5) {
                            ...
                            final View customLayout1 = getLayoutInflater().inflate(R.layout.custom_layout, null);
                            myBuilder.setView(customLayout1);
                            editText = customLayout1.findViewById(R.id.et_text);
                    ...
                    if (currentQuestion.getQn1Image() != 0) {
                        ...
                        if (ans1 == currentQuestion.getCorrectNum1()) {
                            ...
                            if (streak == 5) {
                                ...
                                myBuilder.setView(customLayout2);
                                editText = customLayout2.findViewById(R.id.et_text);
                                editText.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
                                myBuilder.setCancelable(false);
                                //myBuilder.setPositiveButton("Next", (dialogInterface, i) -> Intent intent = new Intent(IntermediateQuestionsActivity.this,AdvancedQuestionsActivity));
                                myBuilder.setPositiveButton("Check Results", (dialogInterface, i) -> {
